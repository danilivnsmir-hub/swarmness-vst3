...
Футсвичи работают как настоящие моментальные педали: **+1 OCT**, **+2 OCT** и **MAGIC** включают свой эффект сразу, даже если плагин выключен кнопкой **ON** или выключена секция RAINBOW. Кнопка **ON** управляет только тем, что звучит, когда футсвичи отпущены.
